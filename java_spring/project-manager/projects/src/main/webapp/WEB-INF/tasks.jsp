...
<body>
	<div
		...
		<h3>
			Project:
			<c:out value="${theproject.title}" />
		</h3>

		<h3>
			Project lead:
			<c:out value="${theproject.lead.firstName}" />
		</h3>



		<form:form action="/projects/${theproject.id}/tasks/create"
			...
			<div class="form-group">
				...
				<form:textarea class="form-control" id="exampleFormControlTextarea1"
					rows="3" path="name"></form:textarea>
			</div>
		...
		<c:forEach var="task" items="${theproject.tasks}">
			...
			<h3>
				Added by
				<c:out value="${task.creator.firstName}" />
				at
