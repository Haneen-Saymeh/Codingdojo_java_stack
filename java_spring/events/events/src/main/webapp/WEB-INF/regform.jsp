    ...
    <div style="width:500px; height:500px; padding: 15px  "  >
     ...
     <form:form action="/register" method="post" modelAttribute="newUser">
        ...
        <div class="form-group">
            ...
            <form:input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" path="firstName"></form:input>
        </div>
        
        <div class="form-group">
            <form:label path="lastName" >Last Name</form:label>
            <form:errors path="lastName" class="text-danger" />
            <form:input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" path="lastName"></form:input>
        </div>
        
         <div class="form-group">
          <form:label path="location" >Location</form:label>
          <form:errors path="location" class="text-danger" />
          <form:input  class="form-control" aria-describedby="emailHelp" path="location"></form:input>
        </div>
